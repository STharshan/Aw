...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Hands down the best detailing experience I’ve had. They showed up right on time and crushed it. The interior is 10/10 perfect. Fast, professional, and the pricing is actually sensible. Definitely a 5-star service!",
    name: "Jason Carey",
  },
